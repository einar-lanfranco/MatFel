package MatFel::Schema::Result::Snort_ipheader;
...
__PACKAGE__->might_have(tcp_header => 'MatFel::Schema::Result::Snort_tcpheader',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
__PACKAGE__->might_have(udp_header => 'MatFel::Schema::Result::Snort_udpheader',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
__PACKAGE__->might_have(icmp_header => 'MatFel::Schema::Result::Snort_icmpheader',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
__PACKAGE__->might_have(data => 'MatFel::Schema::Result::Snort_data',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
__PACKAGE__->belongs_to(ip_proto => 'MatFel::Schema::Result::Protocolo' );
__PACKAGE__->might_have(opt_proto => 'MatFel::Schema::Result::Snort_opt',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid','foreign.opt_proto' => "0"});
...
sub get_geo_ip_src {
my ($self)=@_;
  return(MatFel::Controller::Utilidades::get_geo_ip($self->get_ip_src,0));
}


sub get_geo_ip_dst {
  my ($self)=@_;
  return(MatFel::Controller::Utilidades::get_geo_ip($self->get_ip_dst,0));
}
