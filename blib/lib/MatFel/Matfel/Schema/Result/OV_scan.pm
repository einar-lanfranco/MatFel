package MatFel::Schema::Result::OV_scan;
...
__PACKAGE__->belongs_to(estado => 'MatFel::Schema::Result::OV_estado');
__PACKAGE__->belongs_to(frecuencia => 'MatFel::Schema::Result::OV_frecuencia');
__PACKAGE__->has_many(resultados => 'MatFel::Schema::Result::OV_scanresults',  { 'foreign.id_scan' => 'self.id' } );
