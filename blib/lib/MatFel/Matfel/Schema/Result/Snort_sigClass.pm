package MatFel::Schema::Result::Snort_sigClass;
...
# Set the table name
__PACKAGE__->table('sig_class');
# Set columns in table
__PACKAGE__->add_columns(qw/sig_class_id sig_class_name/);
# Set the primary key for the tabl
__PACKAGE__->set_primary_key(qw/sig_class_id/);
#
# Set relationships:
#
# has_many():
...
# __PACKAGE__->has_many(map_sig_id => 'MatFel::Schema::Result::Snort_signature', 'sig_id');
