package MatFel::Schema::Result::Snort_evento;
...
__PACKAGE__->belongs_to(sig_id => 'MatFel::Schema::Result::Snort_signature', 'signature');
__PACKAGE__->belongs_to(alerta => 'MatFel::Schema::Result::Alerta',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
__PACKAGE__->belongs_to(ip_header => 'MatFel::Schema::Result::Snort_ipheader',{ 'foreign.sid' => 'self.sid','foreign.cid' => 'self.cid'} );
