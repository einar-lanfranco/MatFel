package Tesis::Schema::Result::Snort_signature;
...
__PACKAGE__->add_columns(qw/sig_id sig_name sig_rev sig_class_id sig_priority sig_sid sig_gid/);
# Set the primary key for the tabl
__PACKAGE__->set_primary_key(qw/sig_id/);
#
# Set relationships:
#
# has_many():
...
__PACKAGE__->belongs_to(map_class_id => 'Tesis::Schema::Result::Snort_sigClass', 'sig_class_id');
__PACKAGE__->has_many(map_sig_referencia => 'Tesis::Schema::Result::Snort_sig_reference', 'sig_id');
