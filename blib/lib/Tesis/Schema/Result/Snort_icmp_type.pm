package Tesis::Schema::Result::Snort_icmp_type;
...
# __PACKAGE__->belongs_to(icmpheader => 'Tesis::Schema::Result::Snort_ipheader',{ 'foreign.sid' => 'self.sid'},{'foreign.cid' => 'self.cid'} );
# __PACKAGE__->might_have(icmpcode => 'Tesis::Schema::Result::Snort_ipheader',{ 'foreign.sid' => 'self.sid'},{'foreign.cid' => 'self.cid'} );        
=head1 NAME
