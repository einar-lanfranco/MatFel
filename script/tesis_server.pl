...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TESIS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TESIS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
tesis_server.pl - Catalyst Testserver

=head1 SYNOPSIS

tesis_server.pl [options]
