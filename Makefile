...
#     DIR => []
#     DISTNAME => q[Tesis]
#     EXE_FILES => [q[script/tesis_cgi.pl], q[script/tesis_create.pl], q[script/tesis_fastcgi.pl], q[script/tesis_server.pl], q[script/tesis_test.pl]]
#     NAME => q[Tesis]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { parent=>q[0], Catalyst::Plugin::Static::Simple=>q[0], ExtUtils::MakeMaker=>q[6.42], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Action::RenderView=>q[0], Catalyst::Plugin::Session=>q[0], Catalyst::Plugin::Session::Store::FastMmap=>q[0], Catalyst::Plugin::Authentication=>q[0], Catalyst::Plugin::Session::State::Cookie=>q[0], Config::General=>q[0], Catalyst::Runtime=>q[5.7014] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/model_DB.t] }
...
PM_TO_BLIB = lib/Tesis/Controller/Root.pm \
...
EXE_FILES = script/tesis_cgi.pl script/tesis_create.pl script/tesis_fastcgi.pl script/tesis_server.pl script/tesis_test.pl

pure_all :: $(INST_SCRIPT)/tesis_server.pl $(INST_SCRIPT)/tesis_fastcgi.pl $(INST_SCRIPT)/tesis_cgi.pl $(INST_SCRIPT)/tesis_create.pl $(INST_SCRIPT)/tesis_test.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/tesis_server.pl $(INST_SCRIPT)/tesis_fastcgi.pl \
	  $(INST_SCRIPT)/tesis_cgi.pl $(INST_SCRIPT)/tesis_create.pl \
	  $(INST_SCRIPT)/tesis_test.pl 
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/model_DB.t
TESTDB_SW = -d
