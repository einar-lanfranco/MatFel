package MatFel::Schema::Result::Trafico_entrada_bloqueado;
...
# Set the table name
__PACKAGE__->table('trafico_entrada_bloqueado');
# Set columns in table
__PACKAGE__->add_columns(qw/id id_servidor protocolo puerto ip_origen mascara_origen estado habilitado/);
