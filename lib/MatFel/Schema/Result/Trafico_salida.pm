package MatFel::Schema::Result::Trafico_salida;
...
# Set the table name
__PACKAGE__->table('trafico_salida');
# Set columns in table
__PACKAGE__->add_columns(qw/id id_servidor protocolo puerto ip_destino mascara_destino estado habilitado comentario/);
