package MatFel::Schema::Result::OV_scanresults;
...
__PACKAGE__->belongs_to(risk => 'MatFel::Schema::Result::OV_risk_factor');
__PACKAGE__->belongs_to(id_scan => 'MatFel::Schema::Result::OV_scan');
...
return MatFel::Controller::Utilidades::esta_trafico_entrada_bloqueado( $self->result_source->schema , $self->id_scan->id_servidor->id, $self->puerto, $self->protocolo);
}
