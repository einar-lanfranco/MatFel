package MatFel::Schema::Result::Estado;
...
__PACKAGE__->has_many(trafico_entrada => 'MatFel::Schema::Result::Trafico_entrada', 'estado');    
__PACKAGE__->has_many(trafico_entrada => 'MatFel::Schema::Result::Trafico_salida', 'estado');
