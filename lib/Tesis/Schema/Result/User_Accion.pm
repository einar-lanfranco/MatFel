package Tesis::Schema::Result::User_Accion;
...
__PACKAGE__->belongs_to(user_id => 'Tesis::Schema::Result::User', 'id');
...
if ($self->desde){
  $record= Tesis::Controller::Utilidades::get_geo_ip($self->desde,0);
}
