package Tesis::Schema::Result::User;
...
__PACKAGE__->has_many(map_user_roles => 'Tesis::Schema::Result::UserRole', 'user_id');
__PACKAGE__->has_many(servidores => 'Tesis::Schema::Result::Servidor', 'user');
__PACKAGE__->has_many(acciones => 'Tesis::Schema::Result::User_Accion', 'user_id');
# many_to_many():
#   args:
#     1) Name of relationship, DBIC will create accessor with this name
